...
<div class="callout"><b>Нет под рукой Koleston Perfect нужного оттенка?</b> Номерная система (глубина/тон) у Wella и Londa общая — один и тот же код на постоянной аммиачной краске означает один и тот же результат. Например, Koleston 7/0 и Londa 7-0 — оба «блонд натуральный». Можно смело заменять один бренд на другой по коду, если под рукой оказалась только Londa Professional — подробный разбор соответствия будет отдельной статьёй.</div>
