...
<ul class="marker-legend">
  <li><span class="marker-dot" style="background:#b3006a"></span><span>Малиновая точка — <b>Permanent</b> (аммиачная линия, палитра ниже)</span></li>
...
Ниже — две отдельные интерактивные палитры, по числу товарных линий в прайсе: **Permanent** (в прайсе — «LC крем-краска») и **безаммиачная** (в прайсе — «LC тонирование»). Один и тот же номер оттенка может встречаться в обеих — это два разных товара с разными артикулами и ценой. Часть кодов, которые есть на карте, сейчас нет в актуальном прайсе — они отмечены серой обводкой, без цены.
